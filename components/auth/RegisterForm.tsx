                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    dark:text-white ring-offset-0" placeholder="Enter Name" {...field} />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input className="bg-slate-100 dark:bg-slate-500 border-0
                                    focus-visible:ring-0 text-black
                                    dark:text-white ring-offset-0" placeholder="Enter Email" {...field} />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input className="bg-slate-100 dark:bg-slate-500 border-0
                                    focus-visible:ring-0 text-black
                                    dark:text-white ring-offset-0" placeholder="Enter Password" type="password" {...field} />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    ...
                                    <FormControl>
                                        <Input className="bg-slate-100 dark:bg-slate-500 border-0
                                    focus-visible:ring-0 text-black
                                    dark:text-white ring-offset-0" placeholder="Enter Confirm Password" type="password" {...field} />
                                    </FormControl>
                                    <FormMessage />
                                </FormItem>
                            )}
