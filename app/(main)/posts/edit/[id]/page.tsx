...
const PostEditPage = ({params}: PostEditPageProps) => {
    ...
    const handleSubmit = (data: z.infer<typeof formSchema>) => {
        toast({title:"Post has been updated successfully",description: `Updated by ${post?.author} on ${post?.date}`});
    };
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    ...
                                    dark:text-white ring-offset-0" placeholder="Enter Title" {...field} />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )}
                    ...
                    <FormField
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Textarea className="bg-slate-100 dark:bg-slate-500 border-0
                                    focus-visible:ring-0 text-black
                                    dark:text-white ring-offset-0" placeholder="Enter Body" {...field} />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )}
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input className="bg-slate-100 dark:bg-slate-500 border-0
                                    focus-visible:ring-0 text-black
                                    dark:text-white ring-offset-0" placeholder="Enter Author" {...field} />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )}
                        ...
                        render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl>
                                    <Input className="bg-slate-100 dark:bg-slate-500 border-0
                                    focus-visible:ring-0 text-black
                                    dark:text-white ring-offset-0" placeholder="Enter Date" {...field} />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )}
